...
def readfile():
    with open('/Users/zhaopeng/Projects/github/pytorch-beginner/02-Logistic Regression/data/raw/train-images-idx3-ubyte','rb') as f1:
        buf1 = f1.read()
    with open('/Users/zhaopeng/Projects/github/pytorch-beginner/02-Logistic Regression/data/raw/train-labels-idx1-ubyte','rb') as f2:
        buf2 = f2.read()
    return buf1, buf2
